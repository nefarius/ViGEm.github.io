...
- If you want your controller's LEDs to represent the current battery level, see `Simple Led Control -> Example 2` in the `Light Bar to LEDs translation` section
