...
!!! danger highlight "Do NOT attempt to manually PAIR it with the built-in methods!"
    ...
    This will **not work** and can cause Bluetooth connection to fail completely, **so not do this!**
